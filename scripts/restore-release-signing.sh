...
chmod 600 "${keystore}"
{
  echo "MAXSPEEDVPN_KEYSTORE_PATH=${keystore}"
  echo "MAXSPEEDVPN_KEYSTORE_PASSWORD=${KEYSTORE_PASSWORD}"
  echo "MAXSPEEDVPN_KEY_ALIAS=${KEY_ALIAS}"
  echo "MAXSPEEDVPN_KEY_PASSWORD=${KEY_PASSWORD}"
} >> "${GITHUB_ENV}"
